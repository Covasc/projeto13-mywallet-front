...
export default function NewExpense () {
    ...
    const [entry, setEntry] = useState({type: "expense"});
    ...
    return (
        <NewEntryDiv>
            ...
            <form onSubmit={sendObject}>
                ...
                <button disabled={disable} type='submit'>{disable === true? <ThreeDots color="white" height={80} width={80} />: 'Salvar saída'}</button>
            </form>
        </NewEntryDiv>
    );
}
